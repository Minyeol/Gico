...
public class FragmentProblemsUnit10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit10, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems10);
        unitTemplate.setImage(R.drawable.fileio_icon);
        unitTemplate.setUnit("10. 파일입출력");
        homeButton4 = rootView.findViewById(R.id.homeButton10);
        ...
        RecyclerView smallRecyclerView1 = rootView.findViewById(R.id.smallRecyclerView10);
