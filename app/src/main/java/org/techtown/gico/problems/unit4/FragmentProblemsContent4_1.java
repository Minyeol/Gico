package org.techtown.gico.problems.unit4;
...
public class FragmentProblemsContent4_1 extends Fragment {

    ImageButton homeButton4_1;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_content4_1_problems, container, false);
