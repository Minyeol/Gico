...
public class FragmentProblemsUnit9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit9, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems9);
        unitTemplate.setImage(R.drawable.struct_icon);
        unitTemplate.setUnit("9. 구조체");
        homeButton4 = rootView.findViewById(R.id.homeButton9);
