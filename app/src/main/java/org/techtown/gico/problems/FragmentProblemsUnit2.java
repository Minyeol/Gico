...
public class FragmentProblemsUnit2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit2, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems2);
        unitTemplate.setImage(R.drawable.condition_icon);
        unitTemplate.setUnit("2. 조건문");
        homeButton4 = rootView.findViewById(R.id.homeButton2);
        ...
        RecyclerView smallRecyclerView1 = rootView.findViewById(R.id.smallRecyclerView2);
