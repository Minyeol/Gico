...
public class FragmentProblemsUnit12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit12, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems12);
        unitTemplate.setImage(R.drawable.random_icon);
        unitTemplate.setUnit("12. 랜덤");
        homeButton4 = rootView.findViewById(R.id.homeButton12);
