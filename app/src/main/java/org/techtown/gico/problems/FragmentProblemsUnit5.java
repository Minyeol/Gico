...
public class FragmentProblemsUnit5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit5, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems5);
        unitTemplate.setImage(R.drawable.function_icon);
        unitTemplate.setUnit("5. 함수");
        homeButton4 = rootView.findViewById(R.id.homeButton5);
        ...
        RecyclerView smallRecyclerView1 = rootView.findViewById(R.id.smallRecyclerView5);
