...
public class FragmentProblemsUnit1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit1, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems1);
        unitTemplate.setImage(R.drawable.input_output_icon);
        unitTemplate.setUnit("1. 기본 입출력");
        homeButton4 = rootView.findViewById(R.id.homeButton1);
