...
public class FragmentProblemsUnit8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_problems_unit8, container, false);
        unitTemplate = rootView.findViewById(R.id.unitTemplate_problems8);
        unitTemplate.setImage(R.drawable.array_icon);
        unitTemplate.setUnit("8. 배열");
        homeButton4 = rootView.findViewById(R.id.homeButton8);
        ...
        RecyclerView smallRecyclerView1 = rootView.findViewById(R.id.smallRecyclerView8);
